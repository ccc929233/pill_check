...
// Access the API key using Vite's standard environment variable mechanism.
const API_KEY = import.meta.env.VITE_GEMINI_API_KEY;

if (!API_KEY) {
  const errorMsg = "Gemini API key is not configured. Please create a .env file in the root directory and add VITE_GEMINI_API_KEY='YOUR_API_KEY'.";
  alert(errorMsg); // For immediate user feedback during development
